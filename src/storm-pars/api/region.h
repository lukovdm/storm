 ...
 */
template<typename ValueType>
std::pair<storm::utility::ExtendedValueType<storm::RationalNumber>, typename storm::storage::ParameterRegion<ValueType>::Valuation> computeExtremalValue(
    ...
    return {storm::utility::convertNumber<storm::utility::ExtendedValueType<storm::RationalNumber>>(res.first), std::move(res.second)};
}

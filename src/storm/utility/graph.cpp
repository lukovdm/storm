...
template bool hasCycle(storm::storage::SparseMatrix<storm::RationalInterval> const& transitionMatrix, boost::optional<storm::storage::BitVector> const& subsystem);

template bool checkIfECWithChoiceExists(storm::storage::SparseMatrix<storm::RationalInterval> const& transitionMatrix,
                                        storm::storage::SparseMatrix<storm::RationalInterval> const& backwardTransitions, storm::storage::BitVector const& subsystem,
                                        storm::storage::BitVector const& choices);
...
template std::pair<storm::storage::BitVector, storm::storage::BitVector> performProb01(storm::models::sparse::DeterministicModel<storm::RationalInterval> const& model,
                                                                                       storm::storage::BitVector const& phiStates,
                                                                                       storm::storage::BitVector const& psiStates);

template std::pair<storm::storage::BitVector, storm::storage::BitVector> performProb01(storm::storage::SparseMatrix<storm::RationalInterval> const& backwardTransitions,
                                                                                       storm::storage::BitVector const& phiStates,
                                                                                       storm::storage::BitVector const& psiStates);
...
template void computeSchedulerProbGreater0E(storm::storage::SparseMatrix<storm::RationalInterval> const& transitionMatrix,
                                            ...
                                            storm::storage::BitVector const& phiStates, storm::storage::BitVector const& psiStates,
                                            storm::storage::Scheduler<storm::RationalNumber>& scheduler, boost::optional<storm::storage::BitVector> const& rowFilter);

template void computeSchedulerProb0E(storm::storage::BitVector const& prob0EStates, storm::storage::SparseMatrix<storm::RationalInterval> const& transitionMatrix,
                                     storm::storage::Scheduler<storm::RationalNumber>& scheduler);

template void computeSchedulerRewInf(storm::storage::BitVector const& rewInfStates, storm::storage::SparseMatrix<storm::RationalInterval> const& transitionMatrix,
                                     storm::storage::SparseMatrix<storm::RationalInterval> const& backwardTransitions, storm::storage::Scheduler<storm::RationalNumber>& scheduler);

template void computeSchedulerProb1E(storm::storage::BitVector const& prob1EStates, storm::storage::SparseMatrix<storm::RationalInterval> const& transitionMatrix,
...
template std::vector<uint_fast64_t> getTopologicalSort(storm::storage::SparseMatrix<storm::RationalInterval> const& matrix, std::vector<uint64_t> const& firstStates);
